let index = {
  ...
  adminRegistry: require("../../abis/AdminRegistry.json"),
  predictionV3ManagerCLOB: require("../../abis/PredictionMarketV3ManagerCLOB.json"),
  conditionalTokens: require("../../abis/ConditionalTokens.json"),
  myriadCTFExchange: require("../../abis/MyriadCTFExchange.json"),
  feeModule: require("../../abis/FeeModule.json"),
