...
class PolkamarketsSmartAccountBiconomy extends SmartAccount {
  ...
  static singleton = (() => {
    ...
    function createInstance(provider, networkConfig) {
      ...
      const instance = new PolkamarketsSmartAccountBiconomy(web3Provider, options);
...
module.exports = PolkamarketsSmartAccountBiconomy;